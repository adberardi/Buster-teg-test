...
{
    public static DivisionController current;
    ...
    {
        DivisionTextScript.current.SetText(counterToStart);
        counterToStart--;
    ...
    {
        DivisionTextScript.current.FinishText(ObtainResult(), responseUser);
